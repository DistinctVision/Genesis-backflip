...
class LocoEnv(VecEnv):
    ...
    def _update_buffers(self):
        ...
        self.base_lin_vel[:] = utils.gs_transform_by_quat(self.robot.get_vel(), inv_quat_yaw)
        self.base_ang_vel[:] = utils.gs_transform_by_quat(self.robot.get_ang(), inv_base_quat)
